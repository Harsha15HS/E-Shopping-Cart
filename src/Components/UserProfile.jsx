...
function UserProfile() {
    const [userData, setUserData] = useState(store.getState().user.data);
        ...
        <section className="relative pt-36 pb-24 ">
                ...
                <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
                    <div className="flex items-center justify-center relative z-10 mb-2.5">
                        <img src={userData.image} alt="user-avatar-image" className="border-4 border-solid border-white rounded-full" />
                    </div>
                    ...
                    <h3 className="text-center font-manrope font-bold text-3xl leading-10 text-gray-900 mb-3">{userData.firstName} {userData.lastName }</h3>
